...
export default function EtreAppeleForm() {
      ...
      <div>
        ...
        <div className="space-y-5">
          <div className="flex gap-4">
            ...
            <div>
              <p className="text-sm font-medium text-foreground">Réponse rapide</p>
              <p className="text-sm text-muted-foreground">Rappel dans la journée, 7j/7.</p>
            </div>
          </div>
          <div className="flex gap-4">
            <div className="w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center shrink-0">
            ...
            <div>
              <p className="text-sm font-medium text-foreground">Confidentiel</p>
              <p className="text-sm text-muted-foreground">Vos données restent strictement privées.</p>
            </div>
          </div>
          <div className="flex gap-4">
            <div className="w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center shrink-0">
            ...
            <div>
              <p className="text-sm font-medium text-foreground">Préférez appeler ?</p>
              <a
      ...
      <div className="relative lg:-mr-4">
        ...
        <div className="relative rounded-3xl border border-white/40 dark:border-white/10 bg-background/40 backdrop-blur-2xl shadow-2xl shadow-primary/10 p-8 md:p-10 lg:translate-y-2">
          ...
          <div className="relative">
            <h2 className="text-2xl text-foreground mb-1">Demander un rappel</h2>
            <p className="text-sm text-muted-foreground mb-6">Réponse rapide, sans engagement.</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-4" noValidate>
              ...
              <div>
                ...
                >
                  ...
                  >
                    <RadioGroupItem value="soins-infirmiers" id="soins-infirmiers" className="sr-only" />
                    Soins infirmiers
                  </label>
                  <label
                  ...
                  >
                    <RadioGroupItem value="garde-malade" id="garde-malade" className="sr-only" />
                    Garde malade
                  </label>
                </RadioGroup>
                {errors.careType && (
                  <p className="text-xs text-destructive mt-1">{errors.careType}</p>
                )}
              </div>
